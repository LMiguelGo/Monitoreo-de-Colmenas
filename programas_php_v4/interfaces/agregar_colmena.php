...
<head>
    ...
    <style>
        ...
        .btn-volver { margin-top: 15px; background: #ffaf37ff; font-size: 14px; padding: 6px 18px; width: auto; }
        .btn-volver:hover { background: #ffbb55ff; }
    </style>
</head>
<body>
