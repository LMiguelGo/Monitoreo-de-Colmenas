...
<body>
  ...
  <div class="container">
    <h2>Gráficos lineales</h2>

    <a href="grafico_estatico.php" class="link-button">Ver gráfico en un lapso de tiempo</a>
    <a href="grafico_dinamico.php" class="link-button">Ver gráfico de datos en tiempo real</a>
  </div>
