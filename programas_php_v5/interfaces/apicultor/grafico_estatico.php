...
if (strtolower($_SESSION["tipo_usuario"]) != "apicultor") {
...
async function generarGrafico() {
  ...
  const url = `includes/get_datos_grafica_e.php?id_colmena=${idColmena}&inicio=${encodeURIComponent(inicio)}&fin=${encodeURIComponent(fin)}&periodo=${periodo}`;
